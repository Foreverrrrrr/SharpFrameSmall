...
namespace SharpFrameSmall.Common.SQL
{
    internal class SQL_Sqlite
    {
        ...
        /// <param name="commandText">创建语句</param>
        public static void EnsureDatabaseAndTable(string dbPath, string tableName, string commandText)
        {
            ...
            using (SQLiteConnection conn = new SQLiteConnection($"Data Source={dbPath};Version=3;"))
            {
                ...
                using (SQLiteCommand cmd = new SQLiteCommand(checkTableSql, conn))
                {
